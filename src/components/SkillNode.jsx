  ...
  return (
    <>
      ...
      >
        ...
        {/* Enhanced tooltip */}
        <AnimatePresence>
          {showDetailedTooltip && skill.detailedAccomplishments && (
            <motion.div 
              ref={tooltipRef}
              className={`absolute z-[9999] ${tooltipPositions.tooltipClass}`}
            ...
            >
              <div className="bg-gray-900 text-white rounded-lg p-5 shadow-xl w-96 sm:w-[400px] md:w-[450px] max-h-[500px] sm:max-h-[550px] overflow-hidden border border-gray-700">
                {/* Header */}
                ...
                {/* Scrollable content */}
                <div className="overflow-y-auto max-h-[400px] sm:max-h-[430px] custom-scrollbar pr-2 relative"
                     style={{
                       scrollbarWidth: 'thin',
        ...
        {!skill.detailedAccomplishments && (
          <div className={`absolute opacity-0 hover:opacity-100 transition-opacity duration-200 pointer-events-none z-20 ${tooltipPositions.tooltipClass}`}>
